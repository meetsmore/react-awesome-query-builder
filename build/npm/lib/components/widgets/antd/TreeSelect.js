...
function (_PureComponent) {
  ...
  function TreeSelectWidget(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TreeSelectWidget).call(this, props));
  ...
  _createClass(TreeSelectWidget, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_treeSelect["default"], _extends({
        style: {
          minWidth: width,
          width: width
        },
