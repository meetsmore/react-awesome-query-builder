...
function (_PureComponent) {
  ...
  function FieldCascader() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FieldCascader)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(FieldCascader, [{
    ...
    value: function render() {
      ...
      var res = _react["default"].createElement(_cascader["default"], _extends({
        fieldNames: {
          label: 'label',
          value: 'key',
          children: 'items'
      ...
      if (tooltipText) {
        res = _react["default"].createElement(_tooltip["default"], {
          title: tooltipText
        }, res);
      }
