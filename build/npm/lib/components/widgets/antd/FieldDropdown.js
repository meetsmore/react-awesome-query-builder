...
function (_PureComponent) {
  ...
  function FieldDropdown() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FieldDropdown)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(FieldDropdown, [{
    ...
    value: function renderMenuItems(fields) {
      ...
      return (0, _keys["default"])(fields).map(function (fieldKey) {
        ...
        var option = tooltip ? _react["default"].createElement(_tooltip["default"], {
          title: tooltip
        }, label) : label;
        ...
        if (items) {
          return _react["default"].createElement(SubMenu, {
            key: _path,
            title: _react["default"].createElement("span", null, option, " \xA0\xA0\xA0\xA0")
    ...
    value: function renderMenuToggler(togglerLabel, tooltipText, config) {
      var toggler = _react["default"].createElement(_button["default"], {
        size: config.settings.renderSize
      }, togglerLabel, " ", _react["default"].createElement(_icon["default"], {
        type: "down"
      }));

      if (tooltipText) {
        toggler = _react["default"].createElement(_tooltip["default"], {
          placement: "top",
          title: tooltipText
        }, toggler);
      }
    ...
    value: function render() {
      ...
      var fieldMenu = _react["default"].createElement(_menu["default"], _extends({
        //size={config.settings.renderSize}
