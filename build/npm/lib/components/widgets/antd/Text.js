...
function (_PureComponent) {
  ...
  function TextWidget() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TextWidget)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(TextWidget, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_col["default"], null, _react["default"].createElement(_input["default"], _extends({
        key: "widget-text",
        size: renderSize,
        ref: "text",
        type: "text",
