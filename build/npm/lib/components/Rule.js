...
var Rule = (_dec = (0, _Draggable["default"])("rule"), (0, _RuleContainer["default"])(_class = _dec(_class = (_temp = _class2 =
/*#__PURE__*/
function (_PureComponent) {
  ...
  _createClass(Rule, [{
    ...
    value: function render() {
      ...
      var field = _react["default"].createElement(FieldWrapper, {
        key: "field",
      ...
      var operator = _react["default"].createElement(OperatorWrapper, {
        key: "operator",
        config: this.props.config,
        selectedField: this.props.selectedField,
      ...
      var widget = showWidget && _react["default"].createElement(_col["default"], {
      ...
      var operatorOptions = showOperatorOptions && _react["default"].createElement(_col["default"], {
      ...
      var beforeWidget = renderBeforeWidget && _react["default"].createElement(_col["default"], {
      ...
      var afterWidget = renderAfterWidget && _react["default"].createElement(_col["default"], {
      ...
      var del = _react["default"].createElement("div", {
        key: "rule-header",
...
function (_PureComponent2) {
  ...
  _createClass(FieldWrapper, [{
    ...
    value: function render() {
      ...
      }, config.settings.showLabels && _react["default"].createElement("label", null, config.settings.fieldLabel), _react["default"].createElement(_Field["default"], {
        config: config,
...
function (_PureComponent3) {
  ...
  function OperatorWrapper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(OperatorWrapper).apply(this, arguments));
  }
  ...
  _createClass(OperatorWrapper, [{
    ...
    value: function render() {
      ...
      var operator = showOperator && _react["default"].createElement(_col["default"], {
        key: "operators-for-" + (selectedFieldPartsLabels || []).join("_"),
        className: "rule--operator"
      }, config.settings.showLabels && _react["default"].createElement("label", null, config.settings.operatorLabel), _react["default"].createElement(_Operator["default"], {
        key: "operator",
        config: config,
        selectedField: selectedField,
      ...
      var hiddenOperator = showOperatorLabel && _react["default"].createElement(_col["default"], {
        key: "operators-for-" + (selectedFieldPartsLabels || []).join("_"),
        className: "rule--operator"
      }, _react["default"].createElement("div", {
        className: "rule--operator"
      }, config.settings.showLabels ? _react["default"].createElement("label", null, "\xA0") : null, _react["default"].createElement("span", null, selectedFieldWidgetConfig.operatorInlineLabel)));
