    ...
    _createClass(WidgetContainer, [{
      ...
      value: function render() {
        ...
        return _react["default"].createElement(Widget, {
          ...
          var sepLabel = settings.showLabels ? _react["default"].createElement("label", null, "\xA0") : null;
          var sourceLabel = settings.showLabels ? _react["default"].createElement("label", null, "\xA0") : null;
          var widgetLabel = settings.showLabels ? _react["default"].createElement("label", null, valueLabel.label) : null;

          var sep = sepText && _react["default"].createElement("div", {
            key: "widget-separators-" + delta,
            className: "widget--sep"
          }, sepLabel, _react["default"].createElement("span", null, sepText));

          var sources = valueSources.length > 1 && _react["default"].createElement("div", {
            key: "valuesrc-" + field + "-" + delta,
            className: "widget--valuesrc"
          }, sourceLabel, _react["default"].createElement(_ValueSources.ValueSources, {
            key: 'valuesrc-' + delta,
            delta: delta,
            valueSources: valueSources,
            valueSrc: valueSrc,
          ...
          var widgetCmp = _react["default"].createElement("div", {
            key: "widget-" + field + "-" + delta,
            className: "widget--widget"
          }, valueSrc == 'func' ? null : widgetLabel, _react["default"].createElement(WidgetFactory, _extends({
            valueSrc: valueSrc,
            delta: delta,
            value: value,
            isFuncArg: isFuncArg
