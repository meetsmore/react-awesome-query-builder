...
var _default = function _default(Builder) {
  ...
  function (_Component) {
    ...
    function SortableContainer(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(SortableContainer).call(this, props));
    ...
    _createClass(SortableContainer, [{
      ...
      value: function render() {
        return _react["default"].createElement(Builder, _extends({}, this.props, {
