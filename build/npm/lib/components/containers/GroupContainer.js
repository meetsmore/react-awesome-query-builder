...
var _default = function _default(Group) {
  ...
  function (_Component) {
    ...
    function GroupContainer(props) {
      ...
      _this.addRuleAction = function () {
        _this.props.actions.addRuleAction(_this.props.path);
      };
    ...
    _createClass(GroupContainer, [{
      ...
      value: function render() {
        ...
        }, [isDraggingMe ? _react["default"].createElement(Group, {
          key: "dragging",
          id: this.props.id,
        ...
        }) : null, _react["default"].createElement(Group, {
          key: this.props.id,
          id: this.props.id,
          isDraggingMe: isDraggingMe,
