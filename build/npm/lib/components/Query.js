...
var configKeys = ["conjunctions", "fields", "types", "operators", "widgets", "settings", "funcs", "ruleActions"];
...
function (_PureComponent) {
  ...
  _createClass(Query, [{
    ...
    value: function _updateActions(props) {
      ...
      this.actions = (0, _stuff.bindActionCreators)(_objectSpread({}, actions.tree, {}, actions.group, {}, actions.rule, {}, actions.ruleAction), config, dispatch);
    }
  }, {
    key: "onPropsChanged",
...
function (_Component) {
  ...
  function QueryContainer(props, context) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(QueryContainer).call(this, props, context));
    ...
    _this2.state = {
      store: (0, _redux.createStore)(store, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()),
  ...
  _createClass(QueryContainer, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_configProvider["default"], {
        ...
        store: store
      }, _react["default"].createElement(ConnectedQuery, {
        store: store,
        config: config,
        onChange: onChange,
