...
exports.removeRuleAction = exports.addRuleAction = exports.moveItem = exports.removeGroup = exports.addGroup = exports.removeRule = exports.addRule = exports.setTree = void 0;
...
var addRuleAction = function addRuleAction(config, path) {
  return {
    type: constants.ADD_RULE_ACTION,
    path: path,
    id: (0, _uuid["default"])(),
    properties: (0, _defaultUtils.defaultRuleActionProperties)(config),
    config: config
  };
};
...
var removeRuleAction = function removeRuleAction(config, path) {
  return {
...
exports.removeRuleAction = removeRuleAction;