...
exports.defaultRoot = exports.getChild = exports.defaultRuleActionProperties = exports.defaultGroupProperties = exports.defaultConjunction = exports.defaultRuleProperties = exports.defaultOperatorOptions = exports.defaultOperator = exports.defaultField = void 0;
...
var defaultRuleProperties = function defaultRuleProperties(config) {
  ...
  if (field && operator) {
    var _getNewValueForFieldO = (0, _validation.getNewValueForFieldOp)(config, config, current, field, operator, 'operator', false),
...
var defaultRuleActionProperties = function defaultRuleActionProperties(config) {
  return new _immutable["default"].Map({
    name: null
  });
}; //------------
...
exports.defaultRuleActionProperties = defaultRuleActionProperties;
